...
<style>
	...
	.mousecatcher {	background: rgba(255,255,255,.01);position: absolute;	left: 0;top: 0;width: 100%;	height: 100%;z-index:999	}
	.divider {background:transparent;position: absolute;	z-index: 10;display: none;filter: blur(1px)}
	.divider::after {content: '';position: absolute;background-color: var(--splitter);}
	.dragging {background:gray}
